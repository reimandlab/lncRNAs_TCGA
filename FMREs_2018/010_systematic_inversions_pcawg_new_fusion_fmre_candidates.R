...
#**** translocations
load("k.frame_complete.rsav")
head(k.frame_complete)
...
write.table(exp_results, file="50_translocations_wexp.txt", quote=F, row.names=F)
saveRDS(exp_results, file="50_translocations_wexp.rds")
