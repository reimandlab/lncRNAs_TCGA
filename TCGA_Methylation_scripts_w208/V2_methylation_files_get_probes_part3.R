...
sig_diff = filter(lnc_meth_cancer_data2, wilcoxon_pval <=0.05) #138/362 lncRNA-probes are significant 

#plot just the sig ones 
sig_diff$combo = paste(sig_diff$gene, sig_diff$cancer, sep="_") #37/88 unique combos ~ 40% 
