...
Previous versions of this archive contained the file hsapiens.pathways.ENSG.gmt. The equivalent file can be created by concatenating
the gmt files for GO:BP (hsapiens.GO:BP.ENSG.gmt) and REACTOME (hsapiens.REAC.ENSG.gmt
