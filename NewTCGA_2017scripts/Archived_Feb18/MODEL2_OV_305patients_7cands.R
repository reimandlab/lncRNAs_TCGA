...
train[,10:ncol(train)] = log1p(train[,10:ncol(train)])
...
test[,3:ncol(test)] = log1p(test[,3:ncol(test)])
...
saveRDS(cinds, file="MODEL2_305_OV_pats_CAND_genes_CV_1000timesJan26.RDS")
