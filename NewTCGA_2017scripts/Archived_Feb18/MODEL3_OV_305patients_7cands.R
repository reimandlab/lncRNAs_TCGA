...
#for this model only need stage and grade as predictors 
train = train[,c(2, 3, 8, 9, 10)]
...
saveRDS(cinds, file="MODEL3_305_OV_pats_grade_stage_age_CV_1000timesJan26.RDS")
