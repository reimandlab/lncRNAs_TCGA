...
#--lncrna
rna = readRDS("5919_lncs_177_PAAD_patients_TCGAnew.rds")
rownames(rna) = rna$gene
rna$gene = NULL
rna = t(rna)

#--pcg
pcg = readRDS("54564_pcgs_177_PAAD_patients_TCGAnew.rds")
...
saveRDS(rna, "5919_lncRNAs_PAAD_Feb5_wclinical_data.rds")
...
saveRDS(pcg, "19438_lncRNAs_tcga_PAAD_Feb5_wclinical_data.rds")
