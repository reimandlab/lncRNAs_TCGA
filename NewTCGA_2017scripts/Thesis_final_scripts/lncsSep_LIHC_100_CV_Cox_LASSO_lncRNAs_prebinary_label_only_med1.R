...
#clin = clin[-z,]
#269 LIHC patients with clinical data 
...
saveRDS(cinds_clin, file="ALL_LIHC_pats_prebin_predictors_clin_cindeces_CV_100_March16_justlncsaswell_med1.rds")
saveRDS(cinds_combined, file="ALL_LIHC_prebin_predictors_combined_cindeces_CV_100_March16_justlncsaswell_med1.rds")
saveRDS(cinds_justlncs, file="ALL_LIHC_prebin_predictors_justlncs_cindeces_CV_100_March16_justlncsaswell_med1.rds")
saveRDS(genes_results, file="ALL_LIHC_pats_prebin_predictors_list_of_sig_genes_CV_100March16_justlncsaswell_med1.rds")
