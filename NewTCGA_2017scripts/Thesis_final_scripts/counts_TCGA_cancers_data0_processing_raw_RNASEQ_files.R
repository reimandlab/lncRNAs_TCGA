...
saveRDS(metastatic_keep, file="counts_tcga_id_Metastatic_samples_type_conversion.txt")
...
lnc_rna = rna[z,]
saveRDS(lnc_rna, "counts_5919_all_tumours_7501_tissues_TCGAnew.rds")

#everything else (includes PCGS, other lncRNAs not in FANTOM)
pcg_rna = rna[-z,]
saveRDS(pcg_rna, "counts_54564_PCGs_all_tumours_7501_tissues_TCGAnew.rds")

#4. normal patients --> lncRNA and pcg data 
saveRDS(norm, "counts_all_genes_563_matched_normal_samples_TCGA_April11.rds")
saveRDS(met, "counts_all_genes_354_matched_metastatic_tumours_TCGA_april.rds")
