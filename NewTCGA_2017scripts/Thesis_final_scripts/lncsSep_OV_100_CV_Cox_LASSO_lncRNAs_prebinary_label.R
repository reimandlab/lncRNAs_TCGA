...
saveRDS(cinds_clin, file="ALL_OV_pats_prebin_predictors_clin_cindeces_CV_100_March16_justlncsaswell.rds")
saveRDS(cinds_combined, file="ALL_OV_prebin_predictors_combined_cindeces_CV_100_March16_justlncsaswell.rds")
saveRDS(cinds_justlncs, file="ALL_OV_prebin_predictors_justlncs_cindeces_CV_100_March16_justlncsaswell.rds")
saveRDS(genes_results, file="ALL_OV_pats_predictors_list_of_sig_genes_CV_100March16_justlncsaswell.rds")
