...
random_permutations = function(canc){ #main permutation cross-validation function, which basically runs elastic net function on 100 random datasets 
  ...
  file = paste("surv_shuffle_0315/", "round", canc, cohort_index, date, perms_surv_results1$round[1], "genes", ".rds", sep="_")
  ...
  file = paste("surv_shuffle_0315/", "round", canc, cohort_index, date, perms_surv_results1$round[1], "cindices", ".rds", sep="_")
