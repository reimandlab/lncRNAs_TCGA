...
get_matched_data = function(cancer){
    ...
    z = which(colnames(dtt) %in% c(as.character(allCands$gene[allCands$canc == dtt$canc[1]]), "canc", 
...
lihc_tcga = rna[z,]
z = which(colnames(lihc_tcga) %in% c("ENSG00000227685", "ENSG00000241345" ,"ENSG00000257622",
  "ENSG00000178977", "ENSG00000228482" ,"ENSG00000263400", "ENSG00000269707",
  "ENSG00000236437" ,"ENSG00000230432", "ENSG00000258731" ,"ENSG00000236760",
 "ENSG00000231918", "OS", "OS.time", "patient"))
lihc_tcga = lihc_tcga[,..z]
saveRDS(lihc_tcga, file="/u/kisaev/LIHC_TCGA_data.rds")
