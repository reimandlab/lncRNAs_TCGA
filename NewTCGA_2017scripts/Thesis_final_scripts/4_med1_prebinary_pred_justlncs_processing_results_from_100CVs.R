...
#1. LIHC
lihc_cinds_clin= readRDS(file="ALL_LIHC_pats_prebin_predictors_clin_cindeces_CV_100_March16_justlncsaswell_med1.rds")
lihc_cinds_justlncs = readRDS(file="ALL_LIHC_prebin_predictors_justlncs_cindeces_CV_100_March16_justlncsaswell_med1.rds")
lihc_cinds_combined=readRDS(file="ALL_LIHC_prebin_predictors_combined_cindeces_CV_100_March16_justlncsaswell_med1.rds")
lihc_genes_results=readRDS(file="ALL_LIHC_pats_prebin_predictors_list_of_sig_genes_CV_100March16_justlncsaswell_med1.rds")
####
...
#2. OV
ov_cinds_clin = readRDS(file="ALL_OV_pats_prebin_predictors_clin_cindeces_CV_100_March16_justlncsaswell_med1.rds")
ov_cinds_justlncs = readRDS(file="ALL_OV_prebin_predictors_justlncs_cindeces_CV_100_March16_justlncsaswell_med1.rds")
ov_cinds_combined = readRDS(file="ALL_OV_prebin_predictors_combined_cindeces_CV_100_March16_justlncsaswell_med1.rds")
ov_genes_results = readRDS(file="ALL_OV_pats_prebin_predictors_list_of_sig_genes_CV_100March16_justlncsaswell_med1.rds")
...
#3. KIRC
kirc_cinds_clin = readRDS(file="ALL_KIRC_pats_prebin_predictors_clin_cindeces_CV_100_March16_justlncsaswell_med1.rds")
kirc_cinds_justlncs = readRDS(file="ALL_KIRC_prebin_predictors_justlncs_cindeces_CV_100_March16_justlncsaswell_med1.rds")
kirc_cinds_combined = readRDS(file="ALL_KIRC_prebin_predictors_combined_cindeces_CV_100_March16_justlncsaswell_med1.rds")
kirc_genes_results = readRDS(file="ALL_KIRC_pats_prebin_predictors_list_of_sig_genes_CV_100March16_justlncsaswell_med1.rds")
...
#4. PAAD
paad_cinds_clin = readRDS(file="ALL_PAAD_pats_prebin_predictors_clin_cindeces_CV_100_March16_justlncsaswell_med1.rds")
paad_cinds_justlncs = readRDS(file="ALL_PAAD_prebin_predictors_justlncs_cindeces_CV_100_March16_justlncsaswell_med1.rds")
paad_cinds_combined = readRDS(file="ALL_PAAD_prebin_predictors_combined_cindeces_CV_100_March16_justlncsaswell_med1.rds")
paad_genes_results = readRDS(file="ALL_PAAD_pats_prebin_predictors_list_of_sig_genes_CV_100March16_justlncsaswell_med1.rds")
...
pdf("100CVs_med1_lncsASwell_prebinary_labelled_predictor_cindecides_fixed_dichotomization.pdf", width=9, height=9)
...
saveRDS(all_chosen_features, file="chosen_features_med1_lncsaswell_100CVs_prebinary_predictors_fixed_dichotomization_March16.rds")
colnames(all_chosen_features) =c("gene", "numChosen", "Cancer")
pdf("chosen_med1_justlncsaswell_features_100CVs_prebinary_predictors_fixed_dichomtization_just_clinical_vs_combined.pdf", height=12)
