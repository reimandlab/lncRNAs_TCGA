...
#1. LIHC
lihc_cinds_clin= readRDS(file="ALL_LIHC_pats_prebin_predictors_clin_cindeces_CV_100_March14.rds")
lihc_cinds_combined=readRDS(file="ALL_LIHC_pats_prebin_predictors_combined_cindeces_CV_100_March14.rds")
lihc_genes_results=readRDS(file="ALL_LIHC_pats_prebin_predictors_list_of_sig_genes_CV_100March14.rds")
...
#2. OV
ov_cinds_clin = readRDS(file="ALL_OV_pats_prebin_predictors_clin_cindeces_CV_100_March14.rds")
ov_cinds_combined = readRDS(file="ALL_OV_prebin_cts_predictors_combined_cindeces_CV_100_March14.rds")
ov_genes_results = readRDS(file="ALL_OV_prebin_cts_predictors_list_of_sig_genes_CV_100March14.rds")
...
#3. KIRC
kirc_cinds_clin = readRDS(file="ALL_KIRC_pats_prebin_predictors_clin_cindeces_CV_100_March14.rds")
kirc_cinds_combined = readRDS(file="ALL_KIRC_prebin_cts_predictors_combined_cindeces_CV_100_March14.rds")
kirc_genes_results = readRDS(file="ALL_KIRC_pats_prebin_predictors_list_of_sig_genes_CV_100March14.rds")
...
#4. PAAD
paad_cinds_clin = readRDS(file="ALL_PAAD_pats_binary_predictors_clin_cindeces_CV_100_March14.rds")
paad_cinds_combined = readRDS(file="ALL_PAAD_pats_binary_predictors_combined_cindeces_CV_100_March14.rds")
paad_genes_results = readRDS(file="ALL_PAAD_pats_binary_predictors_list_of_sig_genes_CV_100March14.rds")
