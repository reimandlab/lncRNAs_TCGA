...
saveRDS(cinds_clin, file="ALL_OV_pats_binary_predictors_clin_cindeces_CV_100_March13.rds")
saveRDS(cinds_combined, file="ALL_OV_pats_binary_predictors_combined_cindeces_CV_100_March13.rds")
saveRDS(genes_results, file="ALL_OV_pats_binary_predictors_list_of_sig_genes_CV_100March13.rds")
