...
#all_cancers = rbind(paad, paad, paad, paad)
pdf("8020_1000CVs_paad_march20th_pval0.05_pcawgdet_correlated_lncs.pdf", width=9, height=9)
ggboxplot(paad, x="predictor", y="cindex", fill="predictor", palette=mypal) +
...
paad_features = dplyr::filter(paad_features, N >=40)
