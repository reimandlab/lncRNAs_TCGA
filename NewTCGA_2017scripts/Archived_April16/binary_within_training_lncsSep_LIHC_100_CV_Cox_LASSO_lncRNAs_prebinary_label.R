...
saveRDS(cinds_clin, file="LIHC_100CV_justclin_detectable_correlated_lncs_PCAWGtcga_mar21.rds")
saveRDS(cinds_combined, file="LIHC_100CV_combined_detectable_correlated_lncs_PCAWGtcga_mar21.rds")
saveRDS(cinds_justlncs, file="LIHC_100CV_justlncs_detectable_correlated_lncs_PCAWGtcga_mar21.rds")
saveRDS(genes_results, file="LIHC_100CV_SIG_genes_detectable_correlated_lncs_PCAWGtcga_mar21.rds")
