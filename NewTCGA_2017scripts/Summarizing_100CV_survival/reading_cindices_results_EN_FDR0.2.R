...
pdf("cindices_results_elastic_net_100CVs_FDR0.2_cancers_May2nd.pdf", width=10, height=10)
...
pdf("summary_of_final_lncRNA_candidates_elastic_net_100CVs_FDR0.2_cancers_May2nd.pdf")
...
gg = g + theme(legend.position = "bottom", legend.text = element_text(colour="black", size=5))
print(gg +  theme(text = element_text(size=10),
