...
#1. 1000 runs batch1
##cindeces
genes1 = readRDS("ALL_KIRC_pats473_binary_predictors_list_of_sig_genes_CV1000Jan23_batch1.rds")
...
genes2 = readRDS("ALL_KIRC_pats473_binary_predictors_list_of_sig_genes_CV1000Jan23_batch2.rds")
...
genes3 = readRDS("ALL_KIRC_pats473_binary_predictors_list_of_sig_genes_CV1000Jan23_batch3.rds")
...
genes4 = readRDS("ALL_KIRC_pats473_binary_predictors_list_of_sig_genes_CV1000Jan23_batch4.rds")
...
genes5 = readRDS("ALL_KIRC_pats473_binary_predictors_list_of_sig_genes_CV1000Jan23_batch5.rds")
...
genes6 = readRDS("ALL_KIRC_pats473_binary_predictors_list_of_sig_genes_CV1000Jan23_batch6.rds")
...
genes7 = readRDS("ALL_KIRC_pats473_binary_predictors_list_of_sig_genes_CV1000Jan23_batch7.rds")
...
genes8 = readRDS("ALL_KIRC_pats473_binary_predictors_list_of_sig_genes_CV1000Jan23_batch8.rds")
...
genes9 = readRDS("ALL_KIRC_pats473_binary_predictors_list_of_sig_genes_CV1000Jan23_batch9.rds")
...
#didn't finish running yet - batch 10 
genes10 = readRDS("ALL_KIRC_pats473_binary_predictors_list_of_sig_genes_CV1000Jan23_batch10.rds")
...
saveRDS(genes, file="final_candidates_10batches_of1000CV_KIRC_cancer_patientsJan29.RDS")
