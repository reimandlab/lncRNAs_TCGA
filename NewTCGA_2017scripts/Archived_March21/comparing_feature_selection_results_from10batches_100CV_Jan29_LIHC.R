...
#1. 1000 runs batch1
##cindeces
genes1 = readRDS("ALL_LIHC_pats300_binary_predictors_list_of_sig_genes_CV1000Feb1_batch1.rds")
...
genes2 = readRDS("ALL_LIHC_pats300_binary_predictors_list_of_sig_genes_CV1000Feb1_batch2.rds")
...
genes3 = readRDS("ALL_LIHC_pats300_binary_predictors_list_of_sig_genes_CV1000Feb1_batch3.rds")
...
genes4 = readRDS("ALL_LIHC_pats300_binary_predictors_list_of_sig_genes_CV1000Feb1_batch4.rds")
...
genes5 = readRDS("ALL_LIHC_pats300_binary_predictors_list_of_sig_genes_CV1000Feb1_batch5.rds")
...
genes6 = readRDS("ALL_LIHC_pats300_binary_predictors_list_of_sig_genes_CV1000Feb1_batch6.rds")
...
genes7 = readRDS("ALL_LIHC_pats300_binary_predictors_list_of_sig_genes_CV1000Feb1_batch7.rds")
...
genes8 = readRDS("ALL_LIHC_pats300_binary_predictors_list_of_sig_genes_CV1000Feb1_batch8.rds")
...
genes9 = readRDS("ALL_LIHC_pats300_binary_predictors_list_of_sig_genes_CV1000Feb1_batch9.rds")
...
genes10 = readRDS("ALL_LIHC_pats300_binary_predictors_list_of_sig_genes_CV1000Feb1_batch10.rds")
...
saveRDS(genes, file="final_candidates_10batches_of1000CV_LIHC_cancer_patientsFeb2.RDS")
