...
canc_data = canc_data[,-c(15,18)] #dont need cancer and sex columns
...
saveRDS(cindes_lncs_vs_clinical, file="cinds_KIRC_clinical_vs_all_lncRNAs_feb9_1000_runs.rds")
...
saveRDS(cindes_individual_lncs, file="cinds_KIRC_individual_lncRNAs_feb9_1000_runs.rds")
