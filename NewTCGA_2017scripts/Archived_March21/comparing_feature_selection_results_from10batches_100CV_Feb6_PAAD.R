...
#1. 1000 runs batch1
##cindeces
genes1 = readRDS("ALL_PAAD_pats_binary_predictors_list_of_sig_genes_CV1000Feb5_batch1.rds")
...
genes2 = readRDS("ALL_PAAD_pats_binary_predictors_list_of_sig_genes_CV1000Feb5_batch2.rds")
...
genes3 = readRDS("ALL_PAAD_pats_binary_predictors_list_of_sig_genes_CV1000Feb5_batch3.rds")
...
genes4 = readRDS("ALL_PAAD_pats_binary_predictors_list_of_sig_genes_CV1000Feb5_batch4.rds")
...
genes5 = readRDS("ALL_PAAD_pats_binary_predictors_list_of_sig_genes_CV1000Feb5_batch5.rds")
...
genes6 = readRDS("ALL_PAAD_pats_binary_predictors_list_of_sig_genes_CV1000Feb5_batch6.rds")
...
genes7 = readRDS("ALL_PAAD_pats_binary_predictors_list_of_sig_genes_CV1000Feb5_batch7.rds")
...
genes8 = readRDS("ALL_PAAD_pats_binary_predictors_list_of_sig_genes_CV1000Feb5_batch8.rds")
...
genes9 = readRDS("ALL_PAAD_pats_binary_predictors_list_of_sig_genes_CV1000Feb5_batch9.rds")
...
genes10 = readRDS("ALL_PAAD_pats_binary_predictors_list_of_sig_genes_CV1000Feb5_batch10.rds")
...
saveRDS(genes, file="final_candidates_10batches_of1000CV_PAAD_cancer_patientsFeb6.RDS")
