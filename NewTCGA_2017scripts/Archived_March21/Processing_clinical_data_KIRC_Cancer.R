###Processing_clinical_data_KIRC_Cancer.R

#File downloaded from firehose 
#folder downlaoded called = gdac.broadinstitute.org_KIRC.Merge_Clinical.Level_1.2016012800.0.0
...
f3 = fread("KIRC.clin.merged.txt", data.table=F, header=F)
f3 = t(f3)
cols = f3[1,1:ncol(f3)]
colnames(f3) = cols
f3 = f3[-1,]
...
saveRDS(f3, "537_KIRC_pats_clinical_data_Jan23_firehose.rds")