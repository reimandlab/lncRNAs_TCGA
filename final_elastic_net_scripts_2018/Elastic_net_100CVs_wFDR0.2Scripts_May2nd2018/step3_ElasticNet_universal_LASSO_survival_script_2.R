...
for(p in 11:15){
	...
	filename_cinds = paste(dat$Cancer[1], "elastic_net_cindices_100_may2_CV.rds", sep="_")
	saveRDS(all_cinds, file=filename_cinds)

	filename = paste(dat$Cancer[1], "elastic_net_lncRNAs_selected_100_may2_CV.rds", sep="_")
