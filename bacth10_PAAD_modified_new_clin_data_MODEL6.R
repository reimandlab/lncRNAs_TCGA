...
means = apply(train[,1:2335], 2, mean) #134 with 0 expression in ALL patients 
...
saveRDS(genes_results, file="ALL_PAAD_pats_binary_predictors_list_of_sig_genes_CV1000Feb5_batch10.rds")
