...
diffE <- function(d){
	...
	negPaths <- gprofiler(neg$ID, organism = "hsapiens", ordered_query= TRUE, min_set_size=50, max_set_size = 200, min_isect_size=10, correction_method="fdr", include_graph=T)
